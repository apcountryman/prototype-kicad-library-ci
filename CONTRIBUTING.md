# Contributing to prototype-kicad-library-ci
The following is a set of guidelines for contributing to `prototype-kicad-library-ci`.
...
- The `prototype-kicad-library-ci` version (Git commit SHA)
